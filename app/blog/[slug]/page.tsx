          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: post.title,
                item: `https://www.onestopoutdoorconstruction.com/blog/${post.slug}`,
              },
            ],
          }),
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image: {
              '@type': 'ImageObject',
              url: 'https://www.onestopoutdoorconstruction.com/og-image.jpg',
              width: 1200,
              height: 630,
            },
            author: {
            ...
            mainEntityOfPage: {
              '@type': 'WebPage',
              '@id': `https://www.onestopoutdoorconstruction.com/blog/${post.slug}`,
            },
